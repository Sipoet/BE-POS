class CreateDiscounts < ActiveRecord::Migration[7.0]
  def change
    ...
    add_index :discounts, [:start_time,:end_time], order: {start_time: :asc, end_time: :desc}
    add_index :discounts, [:start_time,:end_time,:item_code,:supplier_code,:item_type_name,:brand_name],
