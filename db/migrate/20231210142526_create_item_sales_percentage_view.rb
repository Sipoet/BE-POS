  ...
  def up
    ...
    CREATE VIEW item_sales_percentage_reports AS (
      SELECT
        ...
        COALESCE(ROUND(tbl_item.hargajual1 / tbl_item.hargapokok,2) - 1,0) AS margin,
        COALESCE(1 - ROUND(tbl_item.hargapokok/tbl_item.hargajual1,2),0) AS limit_profit_discount,
