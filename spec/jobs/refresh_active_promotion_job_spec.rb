...
RSpec.describe RefreshActivePromotionJob, type: :job do
  describe 'promotion' do
    it 'should active when within range' do
      promotions = [
        Ipos::Promotion.create!(iddiskon: 'promotion1', stsact: false, tgldari: DateTime.now,
                                tglsampai: 1.month.from_now),
        Ipos::Promotion.create!(iddiskon: 'promotion2', stsact: false, tgldari: 1.month.ago,
                                tglsampai: 1.minute.from_now),
