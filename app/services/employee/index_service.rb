class Employee::IndexService < ApplicationService
  ...
  def execute_service
    ...
    render_json(EmployeeSerializer.new(@employees,{meta: meta, fields: @fields}))
  end
  ...
  def extract_params
    permitted_params = @params.permit(:page,:per,:search_text,:order_key,:is_order_asc,fields:[:employees,:role])
