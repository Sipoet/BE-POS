class CustomerGroupDiscount::IndexService < ApplicationService
  ...
  def extract_params
    ...
    allowed_fields = [:customer_group_discount,:customer_group]
  ...
  def find_customer_group_discounts
    ...
    if @sort.present?
      customer_group_discounts = customer_group_discounts.order(@sort)
    else
      customer_group_discounts = customer_group_discounts.order(id: :asc)
    end
