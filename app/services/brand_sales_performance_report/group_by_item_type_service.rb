class BrandSalesPerformanceReport::GroupByItemTypeService < ApplicationService
  def execute_service
    extract_params
    extract_date_range
  ...
  def extract_params
    permitted_params = params.permit(:range_period, :group_period, :value_type, :separate_purchase_year, :brand_name,
                                     last_purchase_years: [], suppliers: [], item_types: [])
