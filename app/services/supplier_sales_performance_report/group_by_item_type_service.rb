class SupplierSalesPerformanceReport::GroupByItemTypeService < ApplicationService
  ...
  def extract_params
    permitted_params = params.permit(:range_period, :group_period, :value_type, :separate_purchase_year, :supplier_code,
                                     last_purchase_years: [], brands: [], item_types: [])
    ...
    return unless @supplier_code.nil?
